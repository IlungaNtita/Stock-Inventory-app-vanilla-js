...
function saveAddForm() {
  ...
  let avarage = parseInt(price) + parseInt(productContainer[currentIndex].avgprice) / 2
  let quantitysum = parseInt(input) + parseInt(productContainer[currentIndex].quantity) 
